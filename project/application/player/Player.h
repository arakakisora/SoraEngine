...
class Player : public Collider
{
  ...
  public:
	...
	/// </summary>
	/// <returns></returns>
	bool GetPlayerMoveRight() { return playerMoveRight_; }
	/// <summary>
	/// 左移動フラグを取得します
	/// </summary>
	/// <returns></returns>
	bool GetPlayerMoveLeft() { return playerMoveLeft_; }
	/// <summary>
	...
	Vector3 RotateVelocityByPortal(const Vector3& velocity, const Vector3& inDir, const Vector3& outDir);
	...
	void SetPlayerMoveRight(bool right) { playerMoveRight_ = right; }
	/// <summary>
	/// 左移動フラグを設定します
	/// </summary>
	/// <param name="left"></param>
	void SetPlayerMoveLeft(bool left) { playerMoveLeft_ = left; }
  ...
  private:
	...
	std::unique_ptr<ParticleEmitter> deathEffect_;	  // 排気ガスエミッター
	...
	bool playerMoveLeft_ = false;
	bool isDead_ = false; // 死んだ
	int hitCount = 0;	  // 衝突した数
	bool wasTouching_ = false;
	bool hitDamageBlock_ = false;
	int32_t portalCooldown_ = 0;
