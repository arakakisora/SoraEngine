...
//Particle AbsorbLineParticle::Create(std::mt19937& rng, const EulerTransform transform, float lifetime)
//{
//	Particle particle;
//
//	particle.transform.translate = transform.translate;
//	particle.transform.scale = { 2.2f, 2.2f, 2.2f }; // 最初は大きめ
//	particle.transform.rotate = { 0.0f, 0.0f, 0.0f };
//	particle.Velocity = { 0.0f, 0.0f, 0.0f };
//
//	// 黄色っぽい色から始める
...
//}
//
//void AbsorbLineParticle::Update(Particle& particle, float dt, Material* matelialData, float alpha)
//{
//
//	particle.currentTime += dt;
//
